...
const { handleCCAvenueResponse } = require('./src/controllers/transactionsController');
...
app.post('/initiate-payment', catchAsyncError(async (req, res) => {
  ...
  const encryptedData = encrypt(paymentData, process.env.CCAVENUE_WORKING_KEY);
  console.log(encryptedData)

  res.render('paymentPage', { encRequest: encryptedData, access_code: process.env.CCAVENUE_ACCESS_CODE });
